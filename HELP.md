...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.2.7/gradle-plugin/reference/htmlsingle/#aot)
...
```
$ docker run --rm board:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/board
```
